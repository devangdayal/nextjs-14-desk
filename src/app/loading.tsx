...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white bg-opacity-75 dark:bg-gray-900 dark:bg-opacity-75">
      <div className="relative max-w-md w-full p-6 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <ul className="space-y-2 text-gray-700 dark:text-gray-400">
          {[
            ...
            { title: "YouTube Channel", url: "https://www.youtube.com/c/Nextjs" },
            {
